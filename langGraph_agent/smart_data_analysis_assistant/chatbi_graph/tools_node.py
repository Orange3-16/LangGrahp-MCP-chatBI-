...
import os
import sys
sys.path.append("C:/Users/pengzicheng/Desktop/mcp_langgraph_chatbi/langGraph_agent/smart_data_analysis_assistant")
sys.path.append("C:/Users/pengzicheng/Desktop/mcp_langgraph_chatbi/langGraph_agent/smart_data_analysis_assistant/chatbi_graph")
...
try:
    db = SQLDatabase.from_uri(
        f"mysql+pymysql://{user}:{password}@{db_host}:{db_port}/{dbname}",
...
你是一个设计用于与MySQL数据库交互的智能体，你的任务是调用db_sql_tool工具根据任务编写SQL查询语句，然后再调用db_sql_tool工具执行SQL查询获取到精确查询结果。
